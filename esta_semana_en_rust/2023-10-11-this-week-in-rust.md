...
Por favor, lea el README.md para obtener instrucciones sobre agregar cosas.
Cada enlace enviado debe ser de la forma:

* [Título de la página enlazada](https://example.com/my_article)

Si no sabes qué categoría usar, no dudes en enviar un PR de todos modos
y solo pídele a los editores que seleccionen la categoría.
...
[Reporte completo aquí](https://github.com/rust-lang/rustc-perf/blob/master/triage/2023-10-10.md)
